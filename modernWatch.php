                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    '<div class="product-card">
                        ...
                        <div class="product-tumb">
                            <img src="img/modernwatch/' . $row["image"] . '" alt="watch" class="watch">
